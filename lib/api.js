...
let API_BASE_URL = 'http://16.176.194.83/api'; // fallback (will be probed & replaced)
...
const api = {
  ...
  async testConnection() {
    ...
    try {
      ...
      console.error('❌ Connection test failed:', error?.message || String(error));
      return false;
    }
  },
};
